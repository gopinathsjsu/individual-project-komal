...
class XMLWriterTest {
    ...
    void validateXMLWrite() {
        ...
        String path = "src/test/java/com/sampleFiles/output.xml";
    ...
    void validateXMLWriteFailure() {
        ...
        // Specify the path where the output file will be written
        String path = "src/test/java/com/sampleFiles/output.json";
    ...
    void validateXMLWriteFailure_1() {
        ...
        // Specify the path where the output file will be written
        String path = "src/test/java/com/sampleFiles/json_output.json";
